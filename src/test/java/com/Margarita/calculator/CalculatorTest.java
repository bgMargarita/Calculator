...
public class CalculatorTest {
    ...
    @Test
    public void writeToStack() throws Exception {
        ...
        list.add("*");
        list.add("3");
        assertTrue(answ.containsAll(calculator.writeToStack(list)));
        System.out.println(calculator.writeToStack(list));
    }
    ...
    public void calculatePostfix() throws Exception {
        ...
        System.out.println(calculator.calculatePostfix(calculator.writeToStack(list)));
